...
exports.run = async (client, message, args) => {
  ...
  .setDescription(`**Davet Komutları: ➕ \n Ana Menü: 💡** \n Selamlar davet komutları ve ana menü olarak ikiye ayrılmıştır. `)
...
collector.on('collect', (reaction, user) => {
    ...
    const kobscode = new Discord.MessageEmbed()
      .setColor("BLUE")
 .addField("**Davet Komutları**", `\n**m-**__rütbe-ekle @rol davet__ = **__Rütbe Ekler__** \n**m-**__rütbeler__ = **__Rütbeleri Gösterir 1 Den 10'a Kadar__** \n**m-**__rütbe-sıfırla__ = **__Rütbeyi Sıfırlar.__** \n**m-**__davetleri-sıfırla__ = **__Davetleri Sıfırlar.__** \n**m-**__top__ = **__Lider Tablosunu Gösterir.__** \n**m-**__davetlerim__ = **__Davetlerinizi Gösterir.__** \n**m-**__bonus-ekle__ = **__Bonus Ekler.__** \n**m-**__davet-kanal #kanal__ = **__Davet Kanalını Ayarlar.__** \n**m-**__davet-kanal-sıfırla__ = **__Davet Kanalını Sıfırlar.__**`)
